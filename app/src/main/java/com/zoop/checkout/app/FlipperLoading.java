 ...
 */
public  abstract class FlipperLoading extends ZoopFlipperPane {
    ...
    public void showProgress(final boolean show, final View viewForm, String msg) {
        ...
        mLoginStatusView = getCurrentActivity().findViewById(R.id.login_status);
       ...
       mLoginStatusMessageView.setText(msg);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            int shortAnimTime = getCurrentActivity().getResources().getInteger(
